import { UserScript, GM_addStyle } from "./core/monkey";
...
class CSDN {
    private rules = [
        ...
        },
        {
          ...
          content: [],
          script: () => {
            (document.querySelector('button.slim-video-metadata-header') as HTMLLinkElement).click();
          },
        },
        {
          // AcFun 视频简介
        ...
        },
        {
          ...
          content: [],
          script: () => {
            document.querySelectorAll('*').forEach((el: HTMLDivElement) => {
        ...
        },
        {
          ...
          content: [],
          script: ()=>{
            document.body.querySelectorAll('div').forEach((e: HTMLDivElement)=>{
